...
main { background:transparent !important; margin:0 !important; padding: 80px 0 100px 0 !important; min-height: calc(100vh - 80px) !important; }
.profile-editor { display:grid; grid-template-columns: 1fr 1fr; gap: 40px; max-width: 1000px; margin: 20px auto; padding: 0 20px; }
...
.profile-editor input[type="text"], .profile-editor input[type="email"], .profile-editor input[type="tel"], .profile-editor input[type="password"], .profile-editor textarea { padding: 12px; border: 1px solid #ced4da; border-radius: 4px; font-size: 1rem; transition: border-color 0.3s; background: #ffffff; color: #130325; }
...
.profile-editor textarea { min-height: 80px; resize: vertical; font-family: inherit; }
...
.btn-secondary { background:#6c757d; color:#fff; padding:12px 24px; border:none; border-radius:4px; font-size:1rem; cursor:pointer; transition: background-color 0.3s; font-weight:600; }
...
<div style="max-width: 1200px; margin: 0 auto; padding: 20px;">
    <h1 style="color: var(--primary-light); text-align:center; margin: 0 auto 30px auto !important; font-size: 2rem; font-weight:700;">My Account</h1>

    <div class="profile-editor">
        <div class="personal-info">
            <h2>Account Details</h2>
            <div class="account-summary" style="display:grid; gap:10px;">
                ...
                <div class="summary-row" style="display:flex; justify-content:space-between; gap:10px; color: var(--primary-light); padding:8px 0;"><strong style="color:#FFD736;">Address:</strong> <span><?php echo htmlspecialchars($user['address'] ?? ''); ?></span></div>
            </div>
        ...
        <div class="password-change">
            ...
            <div id="passwordHint" class="hint" style="color: var(--primary-light); opacity:0.8; font-size: 0.9rem; margin-top:8px; text-align:center; padding:15px; background: rgba(255, 215, 54, 0.1); border-radius:4px;">Click "Change Password" button above to update your password.</div>
