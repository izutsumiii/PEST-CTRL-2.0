...
$notifications = getAdminNotifications($userId, 50); // Get more notifications for the full page
...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="flex justify-between items-center mb-8">
            <div>
                <h1 class="text-3xl font-bold text-white mb-2">Admin Notifications</h1>
            </div>
        ...
        <div class="mt-8 flex justify-center space-x-4">
            ...
            <a href="admin-dashboard.php" class="bg-gray-600 hover:bg-gray-700 text-white font-semibold py-2 px-6 rounded-lg transition-colors duration-200">
...
function markAllAsRead() {
    fetch('ajax/mark-all-admin-notifications-read.php', {
        method: 'POST'
    })
    .then(response => response.json())
    .then(data => {
